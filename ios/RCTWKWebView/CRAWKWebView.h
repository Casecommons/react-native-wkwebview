 ...
 */
static NSString *const RCTJSNavigationScheme = @"react-js-navigation";
...
- (void)removeData:(NSArray *)types :(NSArray *)records completionHandler:(void (^)(id, NSError *error))completionHandler;
